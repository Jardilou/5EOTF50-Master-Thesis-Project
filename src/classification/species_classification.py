...
class SpeciesClassifier:
    ...
    def get_raw_embedding(self, image_path, bbox):
        """Extracts deep visual features (color, texture, shape) without applying a species label."""
        ...
        return emb[0] # Return the 1D mathematical fingerprint
