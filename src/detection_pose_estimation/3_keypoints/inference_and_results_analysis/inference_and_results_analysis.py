"""
================================================================================
Script: YOLO-Pose Evaluation and Dijkstra Analytics Pipeline
================================================================================
...
Dependencies:
    - Python standard libraries: os, shutil, time, heapq, multiprocessing
...
Inputs:
    ...
    - test_images_dir: Directory containing unseen validation/test images.
...
if __name__ == '__main__':
    ...
    WEIGHTS = r"C:\Users\Work Mode Big Dog\OneDrive - ECAM\Bureau\ERASMUS\PROJECT\CODE\ultralytics\runs\pose\INSTANCE SEGMENTATION + POSE ESTIMATION\Runs\ExtremityPose\Dual_Strategy_Run_1\weights\best.pt"
    YAML = r"Dual Strategy Fish Pose.yaml"
    TEST_IMAGES = "C:/Users/Work Mode Big Dog/OneDrive - ECAM/Bureau/ERASMUS/PROJECT/CODE/DATASETS/DATASETS FOR INSTANCE SEGMENTATION + POSE ESTIMATION/UMT Dataset/CURRENT/Head+Tail UMT Annotations/train_test_split/images/val" 
    OUT_DIR = "C:/Users/Work Mode Big Dog/OneDrive - ECAM/Bureau/ERASMUS/PROJECT/CODE/INSTANCE SEGMENTATION + POSE ESTIMATION/INFERENCE AND RESULTS ANALYSIS/Results_Dual_Strategy_Run_1"
